    ...
    <div className='container mx-auto p-4 pt-10'>
      ...
      <div className='grid grid-cols-2 gap-10 items-start text-center mx-[20px] pt-[5px]'>
        ...
        <button
          ...
          <svg width="40" height="40" viewBox="0 0 40 40" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="mb-2 text-gray-500 group-hover:text-[#FC7E2A] transition-colors duration-300">
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
        ...
        <div className='flex flex-col items-center'>
          ...
          {preview && (
            <div className="mt-4 w-[200px]">
              <p>미리보기:</p>
              <img src={preview} alt="preview" className='w-full h-[150px] object-cover rounded-md' />
            </div>
          )}
        </div>
      </div>
