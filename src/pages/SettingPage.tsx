    ...
    <motion.div
      ...
      <div>
        <div className="flex flex-com justify-start py-2">
          <img src={kor} alt="kor" className="mx-1" />
          <div className="text-lg font-normal text-[#FC7E2A]">한국어</div>
        </div>
        <div className='flex flex-com justify-start py-2'>
          <img src={eng} alt='eng' className='mx-1'></img>
          <div className='text-lg font-normal'>English</div>
        </div>
        <div className='flex flex-com justify-start py-2'>
          <img src={chn} alt='chn' className='mx-1'></img>
      ...
      <div className='flex justify-start items-center mb-2'>
        ...
        <button onClick={() => window.open("https://www.gg.go.kr/gdream/view/fma/ordmain/main", "_blank")} className='text-[#444444] font-md text-[16px]'>
            경기도 아동급식카드 가맹점 신청페이지
        </button>
      </div>
      {/* 선한영향력가게 가맹점 신청페이지  */}
      <div className='flex justify-start items-center mb-2'>
        ...
        <button onClick={() => window.open("https://www.xn--o39akkz01az4ip7f4xzwoa.com/crew/introduce", "_blank")} className='text-[#444444] font-md text-[16px]'>
          선한영향력가게 가맹점 신청페이지
        </button>
      </div>  
      {/* 좋은이웃가게 가맹점 신청페이지 */}
      <div className='flex justify-start items-center mb-2'>
        ...
        <button onClick={() => window.open("https://goodshop.gni.kr/goodshop/application", "_blank")} className='text-[#444444] font-md text-[16px]'>
          좋은이웃가게 가맹점 신청페이지
        </button>
      </div>
    </motion.div>
